...
namespace API.Data.Migrations
{
    ...
    [Migration("20260425202914_AddedAppoimentServiceReview")]
    partial class AddedAppoimentServiceReview
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppUserService", b =>
                {
                    ...
                    b.Property<int>("FavoriteServicesId")
                        .HasColumnType("INTEGER");

                    b.HasKey("ClientsId", "FavoriteServicesId");

                    b.HasIndex("FavoriteServicesId");
            ...
            modelBuilder.Entity("AppUserService", b =>
                {
                    ...
                    b.HasOne("API.Entities.Service", null)
                        .WithMany()
                        .HasForeignKey("FavoriteServicesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
